...
const projects = [
  {
    ...
    githubUrl: "https://github.com/srinivas-poturi-3/UniConnect",
  ...
  },
  {
    ...
    githubUrl: "https://github.com/srinivas-poturi-3/restaurantFinder",
...

  {
    ...
    githubUrl: "https://github.com/srinivas-poturi-3/mark8",
    imageSrc: "/mark8.png",
  },
];
    ...
    <div className="md:ml-40  px-4 md:px-0 mt-12 lg:mt-20">
      ...
      {projects.map((project, index) => (
        <motion.div
          ...
          key={index}
        >
          <div className=" card flex flex-col lg:gap-4 justify-between lg:items-center px-8 mb-12">
            <div className="max-w-prose gray font-medium  flex flex-col gap-4 w-full mb-8 lg:mb-0">
